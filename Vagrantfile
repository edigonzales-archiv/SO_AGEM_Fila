...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    sudo -u postgres psql -d postgres -c "CREATE DATABASE sogis WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8' OWNER ddluser;"
    ...
    sudo -u postgres psql -d sogis -c "ALTER DATABASE sogis SET postgis.gdal_enabled_drivers TO 'GTiff PNG JPEG';"
    ...
    echo 'deb     http://qgis.org/debian-nightly bionic main' | tee /etc/apt/sources.list.d/qgis.list
